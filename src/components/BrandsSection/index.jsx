...
const BrandsSection = () => {
  return (
    <section className='bg-neutral-75 flex flex-col gap-10 pt-14 pb-8 sm:pt-16 sm:pb-4 lg:pt-32 lg:pb-20 w-full'>
      <header className="container mx-auto text-center px-[5.75%] sm:px-10 font-poppins text-xl sm:text-2xl lg:text-hero-tablet leading-[1.875rem] sm:leading-9">Companies Using EthOS to Make Customer-Centered Decisions</header>
