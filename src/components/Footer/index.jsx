  ...
  return (
    <footer className='w-full bg-main-blue-600 text-footer-text text-base leading-5 px-8 sm:px-9'>
      <div className="my-14 sm:my-16 lg:my-20 flex flex-col sm:flex-row justify-between gap-x-6 gap-y-10">
        <div id='quick-links' className="flex flex-col flex-auto gap-y-8 border border-orange-400">
        ...
        <div className="flex flex-col grow gap-y-8 border border-lime-400">
        ...
        <div id='address' className="flex flex-col gap-y-8 border border-cyan-400">
        ...
        <div className='block sm:hidden h-px w-full bg-footer-text bg-opacity-30' />
        <div id='contact' className="flex sm:hidden flex-col gap-y-8 border border-cyan-400">
          <div className='block sm:hidden text-lg font-semibold text-white'>Contact</div>
          <div className='flex flex-col gap-y-4 border border-yellow-800'>
      ...
      <div id='app-stores' className="flex flex-row justify-between gap-x-6 items-center max-w-xs mb-14 sm:mb-16 lg:mb-20">
